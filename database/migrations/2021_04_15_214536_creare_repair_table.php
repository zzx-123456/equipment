 ...
 * @LastEditTime: 2021-05-03 11:26:33
...
class CreareRepairTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('repair',function(Blueprint $table){
            $table -> increments('id');
            $table -> integer('eqm_id') -> notNull() -> comment('故障设备ID');
            ...
            $table -> tinyInteger('repair_state') -> notNull() -> default('0') -> comment('维修状态：0未维修 1已维修 2报废');
            $table -> string('repair_man',20) -> comment('维修人');
            $table -> dateTime('repair_time') -> comment('维修时间');
            $table -> integer('user_id') -> comment('报修人ID');
        });
    }
